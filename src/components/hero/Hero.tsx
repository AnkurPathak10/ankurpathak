...
/** Hero visual layer only — navbar is rendered in the page shell so it stays above the scroll sheet. */
export function Hero() {
  return (
    <div className="hero-surface relative isolate h-full min-h-0 w-full overflow-x-hidden">
      ...
      <div className="pointer-events-none absolute bottom-0 left-1/2 z-10 h-full w-[60vw] max-w-[96vw] -translate-x-1/2 overflow-hidden">
        <Image
          src="/avatar.png"
